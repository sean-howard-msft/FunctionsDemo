...
namespace Demo.DAL
{
    ...
    public partial class NotifyEntities : DbContext
    {
        ...
        [DbFunction("NotifyEntities", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[NotifyEntities].[ufnGetAllCategories]()");
        }
    
        [DbFunction("NotifyEntities", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[NotifyEntities].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
